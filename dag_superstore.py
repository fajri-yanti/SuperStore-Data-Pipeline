...
from resources.scripts.superstore.extract import extract_table
from resources.scripts.superstore.load import load_table

with open("dags/resources/config/superstore.yaml", "r") as f:
